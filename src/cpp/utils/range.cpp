 ...
 *
 */
size_t tbsla::utils::range::lnv(size_t size, long long int local_pos, long long int number_pos) {
 ...
 *
 */
size_t tbsla::utils::range::pflv(size_t size, long long int local_pos, long long int number_pos) {
  size_t mod = size % number_pos;
