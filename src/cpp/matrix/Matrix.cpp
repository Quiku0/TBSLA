...
#include <numeric>
#include <iostream>
double* tbsla::cpp::Matrix::a_axpx_(const double* v, long long int vect_incr) const {
...
void tbsla::cpp::Matrix::AAxpAx(double* r, double* v, double* buffer, long long int vect_incr) const {
...
void tbsla::cpp::Matrix::AAxpAxpx(double* r, double* v, double* buffer, long long int vect_incr) const {
