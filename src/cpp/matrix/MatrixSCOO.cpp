...
tbsla::cpp::MatrixSCOO::MatrixSCOO(long long int n_row, long long int n_col, double* values, long long int* row, long long int* col) : values(NULL), row(NULL), col(NULL) {
  if (this->values)
    delete[] this->values;
  if (this->row)
    delete[] this->row;
...
tbsla::cpp::MatrixSCOO::MatrixSCOO(long long int n_row, long long int n_col, long long int n_values) : values(NULL), row(NULL), col(NULL) {
  if (this->values)
    delete[] this->values;
  if (this->row)
    delete[] this->row;
...
tbsla::cpp::MatrixSCOO::MatrixSCOO(long long int n_row, long long int n_col) : values(NULL), row(NULL), col(NULL) {
  this->n_row = n_row;
  this->n_col = n_col;
  this->f_row = 0;
  this->f_col = 0;
...
tbsla::cpp::MatrixSCOO::MatrixSCOO(const tbsla::cpp::MatrixCOO & m) : values(NULL), row(NULL), col(NULL) {
  ...
  if (this->row)
    delete[] this->row;
  this->row = new long long int[this->nnz]();
  if (this->col)
    delete[] this->col;
  this->col = new long long int[this->nnz]();
...
double* tbsla::cpp::MatrixSCOO::spmv(const double* v, long long int vect_incr) const {
...
inline void tbsla::cpp::MatrixSCOO::Ax(double* r, const double* v, long long int vect_incr) const {
  if (this->nnz == 0) {
    return;
  }
...
void tbsla::cpp::MatrixSCOO::fill_cdiag(long long int n_row, long long int n_col, long long int cdiag, long long int pr, long long int pc, long long int NR, long long int NC) {
  this->n_row = n_row;
  this->n_col = n_col;
  this->pr = pr;
  this->pc = pc;
...
void tbsla::cpp::MatrixSCOO::fill_cqmat(long long int n_row, long long int n_col, long long int c, double q, unsigned long long int seed_mult, long long int pr, long long int pc, long long int NR, long long int NC) {
  this->n_row = n_row;
  this->n_col = n_col;
  this->pr = pr;
  this->pc = pc;
  ...
  this->row = new long long int[nv];
  this->col = new long long int[nv];
...
/*void tbsla::cpp::MatrixSCOO::fill_random(long long int n_row, long long int n_col, double nnz_ratio, unsigned long long int seed_mult, long long int pr, long long int pc, long long int NR, long long int NC) {
  this->n_row = n_row;
  this->n_col = n_col;
  this->pr = pr;
  this->pc = pc;
...
#pragma omp parallel
  ...
  #pragma omp parallel for schedule(static)
  for(long long int it=0; it<n_threads; it++) {
    long long int start = offsets_t[it];
    //std::cout << "start at " << start << std::endl;
    long long int pos = 0;
    for(long long int itt=0; itt<row_inds_t[it].size(); itt++) {
...
void tbsla::cpp::MatrixSCOO::fill_brain(long long int n_row, long long int n_col, int* neuron_type, std::vector<std::vector<double> > proba_conn, std::vector<std::unordered_map<int,std::vector<int> > > brain_struct, unsigned long long int seed_mult, long long int pr, long long int pc, long long int NR, long long int NC) {
  this->n_row = n_row;
  this->n_col = n_col;
  this->pr = pr;
  this->pc = pc;
...
void tbsla::cpp::MatrixSCOO::get_row_sums(double* s) {
  for(long long int k=0; k<this->nnz; k++) {
