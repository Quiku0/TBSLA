...
struct HPX_COMPONENT_EXPORT MatrixDENSE : ::hpx::components::component_base<MatrixDENSE>
{
    ...
    MatrixDENSE(std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t pr, std::size_t pc, std::size_t NR, std::size_t NC)
      : data_()
    {
...
struct MatrixDENSE : ::hpx::components::client_base<MatrixDENSE, tbsla::hpx_::server::MatrixDENSE>
{
    ...
    MatrixDENSE(hpx::id_type where, std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t pr, std::size_t pc, std::size_t NR, std::size_t NC)
