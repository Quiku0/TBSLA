...
struct HPX_COMPONENT_EXPORT MatrixELL : ::hpx::components::component_base<MatrixELL>
{
    ...
    MatrixELL(std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t pr, std::size_t pc, std::size_t NR, std::size_t NC)
      : data_()
    {
...
struct MatrixELL : ::hpx::components::client_base<MatrixELL, tbsla::hpx_::server::MatrixELL>
{
    ...
    MatrixELL(hpx::id_type where, std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t pr, std::size_t pc, std::size_t NR, std::size_t NC)
