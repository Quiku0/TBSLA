...
struct HPX_COMPONENT_EXPORT MatrixSCOO : ::hpx::components::component_base<MatrixSCOO>
{
    ...
    MatrixSCOO(std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t pr, std::size_t pc, std::size_t NR, std::size_t NC)
      : data_()
    {
...
struct MatrixSCOO : ::hpx::components::client_base<MatrixSCOO, tbsla::hpx_::server::MatrixSCOO>
{
    ...
    MatrixSCOO(hpx::id_type where, std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t pr, std::size_t pc, std::size_t NR, std::size_t NC)
