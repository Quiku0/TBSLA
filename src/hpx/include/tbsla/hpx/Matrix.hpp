...
class Matrix {
  public:
    ...
    virtual void fill_cqmat(std::vector<hpx::id_type> localities, std::size_t nr, std::size_t nc, std::size_t c, double q, unsigned long long int seed, std::size_t gr, std::size_t gc) = 0;
    virtual void wait() = 0;
